  ...
  >
    ...
    >
      ...
      <div class="flex flex-col items-center">
        <div
          class="btn btn-neutral mt-2 cursor-pointer w-full"
        ...
        >
          ...
          <div class="transition-opacity duration-500 delay-250 opacity-0 group-hover:opacity-100 text-center">
    ...
    <dialog id="restart_confirm" ref="restartModal" class="modal">
      <div class="modal-box text-center">
        ...
        <div class="flex gap-x-8 justify-center items-center">
          <div class="cursor-pointer hover:underline" onclick="restart_confirm.close()">Oops! Nevermind.</div>
          <div
